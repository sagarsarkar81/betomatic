      ...
      <div class="row">
         ...
         <div class="col-md-6 col-sm-6 col-xs-12">
            <div class="main-content">
               ...
               <div class="desc">
                  <h3>{{__('label.Change your password')}}</h3>
                    <form class="change_password col-md-8 col-md-offset-2" id="changePasswordForm" name="changePasswordForm" action="javascript:void(0);" method="post" autocomplete="off" onsubmit="ChangePasswordFormSubmit()">
                       <div class="form-group">
                          <input type="password" name="oldPassword" name="oldPassword" class="form-control validate[required]" placeholder="{{__('label.Enter your old password')}}" name="old_password"/>
                       </div>
                       <div class="form-group">
                          <input type="password" name="newPassword" id="newPassword" class="form-control validate[required,minSize[5],maxSize[15]]" placeholder="{{__('label.Enter your new password')}}" name="new_password"/>
                       </div>
                       <div class="form-group">
                          <input type="password" name="confirmPassword" id="confirmPassword" class="form-control validate[required,equals[newPassword]]" placeholder="{{__('label.Enter confirm password')}}" name="confirm_password"/>
                       </div>
                       <button type="submit" class="change_password_button" id="changepass_btn">{{__('label.Save')}}</button>
                    </form>
               </div>
            </div>
         </div>
