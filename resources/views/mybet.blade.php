...
{
?>
  <div class="row" id="leftPartMyBetData">
    <div style="display:none" class="nextDataAjaxMyBet"><?php echo $nextData; ?></div>
      <?php foreach($FeedData as $blockLeftKey => $blockLeftValue)
        {
...
<?php } else{ ?>
 <div style="display:block" class="loadMoreMyBetData"></div>
 <?php } 
 if(!empty($FeedData)) { ?>
  <div class="row" id="rightPartMyBetData">
    <?php foreach($FeedData as $blockLeftKey => $blockLeftValue)
      {
