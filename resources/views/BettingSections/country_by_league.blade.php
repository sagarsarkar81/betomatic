               ...
               <div class="league_wrap">
                  ...
                  <div class="col-md-8 col-sm-12">
                     <div class="Select_odds">
                        <select onchange="GetBookmakerName(this.value)">
                           <?php
                              if(!empty($GetBookmakerArray))
                              {
                                foreach($GetBookmakerArray as $key=>$value)
                                {
                              ?>
                           <option value=<?php echo $value[odd_bookmakers]; ?>><?php echo $value[odd_bookmakers]; ?></option>
                           <?php
                                }
                              }
                              ?>
