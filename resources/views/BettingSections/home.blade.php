            ...
            <div class="dashboard_left">
               ...
               <div class="all_feed_wrap">
                  ...
                  <ul class="nav nav-tabs" role="tablist" id="unid">
                     <li class="{{ Request::path() == 'display-block-new' ? 'active' : '' }}" role="presentation"><a href="#news_feed" aria-controls="news_feed" role="tab" data-toggle="tab">{{__('label.News Feed')}}</a></li>
                     <li class="{{ Request::path() == 'mybet' ? 'active' : '' }} mybet" id="MyBetTab" role="presentation"><a href="#bets" aria-controls="bets" role="tab" data-toggle="tab">{{__('label.My Bets')}} <!--span class="add_match"></span--></a></li>
                  </ul>
                  <!-- Tab panes -->
                  <div class="tab-content">
                     <div role="tabpanel" class="tab-pane {{ Request::path() == 'display-block-new' ? 'active' : '' }}" id="news_feed">
