         ...
         <div class="col-md-8">
            <div class="user_message_wrap">
               <div class="headingContainer">
                  ...
                  <!-- dropdown More -->   
                  <div class="dropdown feed_more chat_settings" id="MessageSettings">
               ...
               <div class="user_message_footer">
                    <textarea data-autoresize  type="text" row="2" id="MessageText" class="form-control" placeholder="Enter your message..."></textarea>
                    <button type="button" class="send_messages" id="SubmitButton" onclick="SendMessage('<?php echo $SelectedUserId; ?>')">
                    <i class="fa fa-paper-plane" aria-hidden="true"></i>
                    </button>
                    <div class="DeleteChatIndividual" style="display: none;" id="">
                        <p>Select Message To Delete  
                            ...
                            <a class="DeleteChatIndividualDelete" href="javascript:void(0);" onclick="DeleteIndividualChat()">Delete</a>
                        </p>
                    </div>
               </div>
            </div>
