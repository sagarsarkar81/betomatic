                           ...
                           <div class="leaderboard_body follow_body">
                              ...
                              { 
                                    ...
                                    { 
                                        ...
                                        if($DataValue['id'] != $VisitorUserId) 
                                        {
                                            $UserFollowData = follow_users::where('from_userid',$VisitorUserId)->where('to_user_id',$DataValue['id'])->get()->toArray();
                              ...
                              <?php } } } } } ?>
                              <?php
                              $UserFollowData = follow_users::where('from_userid',$VisitorUserId)->get()->toArray();
                              if(empty($UserFollowData))
                              {
                              ?>
                              <p class="No_team_info">Currently your are not following anyone</p>  
                              <?php 
                              }
                              ?>
                            </div>
